...
### [**B2B SaaS Churn Analytics Pipeline**](https://github.com/aryannair767/b2b-churn-analysis-with-ml)
* **Objective:** Predict customer churn and identify at-risk monthly recurring revenue (MRR) before cancellation.
* **Methodology:** Executed advanced SQL feature engineering (CTEs, window functions) via DataGrip to extract 17 business insights, followed by machine learning classification (Random Forest).
* **Result:** Deployed an interactive Streamlit web application and executive Power BI dashboard, successfully flagging 241 high-risk accounts and $521K in at-risk MRR.
